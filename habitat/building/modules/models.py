...
class Module(models.Model):
    ...
    status = models.CharField(verbose_name=_('Status'), choices=STATUSES, max_length=30, db_index=True, default='nominal')
    hazzard = models.CharField(verbose_name=_('Hazzard'), choices=HAZZARDS, max_length=30, db_index=True, default=None)
    ...
    plan = models.CharField(verbose_name=_('Plan'), choices=PLANS, max_length=30, default=None)
