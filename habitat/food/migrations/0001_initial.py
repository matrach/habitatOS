    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cooking_waste', models.PositiveSmallIntegerField(blank=True, default=None, null=True, validators=[django.core.validators.MaxValueValidator(100), django.core.validators.MinValueValidator(0)], verbose_name='Cooking Waste')),
                ('cooking_factor', models.DecimalField(blank=True, decimal_places=2, default=None, max_digits=3, null=True, validators=[django.core.validators.MaxValueValidator(1.0), django.core.validators.MinValueValidator(0.0)], verbose_name='Cooking Factor')),
                ...
                ('cooking_product', models.ForeignKey(blank=True, default=None, help_text='Dry Product Mass = Cooked Product Mass / Cooking Factor [0.0 - 1.0]', null=True, on_delete=django.db.models.deletion.CASCADE, to='food.Product', verbose_name='From Product')),
            ],
            options={
